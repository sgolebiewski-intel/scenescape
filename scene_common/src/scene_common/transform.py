...
class CameraPose:
    ...
    def projectToMap(self, obj_T, obj_R, map_obj, map_T, map_R):
        ...
        if not distance_ratio == np.inf:
            ...
            v2 = rcast["primitive_normals"].numpy()[
                0
    ...
    def projectBounds(self, rect):
        ...
        baseLen = Point(
            self.translation.x, self.translation.y, 0, polar=False
        ).distance(basePoint)
    ...
    def _poseMatToPose(mat):
        ...
        pose = {
            ...
            "quaternion_rotation": Rotation.from_matrix(
                rmat
            ).as_quat(),  # TEST ME - calculate quaternion
            "euler_rotation": rot,
            "scale": scale,
        }
