...
CAM_FILTER_CHOICES = [(BOTTOM, "Bottom"), (TOP, "Top"), (NONE, "None (default)")]
...
SINGLETON_CHOICES = [(ENVIRONMENTAL, "environmental"), (ATTRIBUTE, "attribute")]

AREA_CHOICES = [(SCENE, "scene"), (CIRCLE, "circle"), (POLY, "poly")]
