...
The `deepscenario-config.json` file can be edited based on [DL Streamer Pipeline Server documentation](https://github.com/open-edge-platform/edge-ai-libraries/tree/release-2026.0.0/microservices/dlstreamer-pipeline-server/docs/user-guide) to customize:
