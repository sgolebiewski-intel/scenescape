...
class AutoCalibration(FunctionalTest):
    def __init__(self, testName, request, recordXMLAttribute):
        ...
        self.initial_cam_points = [
            [119.0, 622.0],
            [257.0, 561.0],
            [978.0, 580.0],
            [628.0, 312.0],
        ]
        self.initial_map_points = [
            [1.685, 2.533],
            [2.188, 2.578],
            [4.449, 1.412],
            [3.94, 3.228],
    ...
    def runAutoCalibration(self):
        ...
        try:
            ...
            if (
                self.updated_map_points is not None
                and self.updated_cam_points is not None
            ):
                if (
                    self.initial_cam_points != self.updated_cam_points
