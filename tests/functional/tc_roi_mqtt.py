...
class ROIMqtt(FunctionalTest):
    ...
    def runROIMqttInitialize(self):
        ...
        self.entered = False
        self.exited = False
        self.roiPoints = ((0.9, 4.0), (0.9, 2.4), (8.1, 2.4), (8.1, 4.0))
    ...
    def runROIMqttPrepare(self):
        ...
        self.getScene()
        roi = {"scene": self.sceneUID, "name": self.roiName, "points": self.roiPoints}

        points = self.setupROI(roi)

        topic_regulated = PubSub.formatTopic(
