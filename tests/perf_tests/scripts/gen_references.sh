...
do
    ...
    percebro/percebro.py -i ${INPDIR}/${INPUT} --mqttid camera1  -i ${INPDIR}/${INPUT2} --mqttid camera2 -i ${INPDIR}/${INPUT3} --mqttid camera3 -m retail --intrinsics=${INTRINSICS} --intrinsics=${INTRINSICS} --intrinsics=${INTRINSICS} --debug ${CORESTR} --preprocess  --frames ${NUMFRAMES}
    ...
    percebro/percebro.py -i ${INPDIR}/${INPUT} --mqttid camera1  -i ${INPDIR}/${INPUT2} --mqttid camera2 -i ${INPDIR}/${INPUT3} --mqttid camera3 -m apriltag,retail+reid --intrinsics=${INTRINSICS} --intrinsics=${INTRINSICS} --intrinsics=${INTRINSICS} --debug ${CORESTR} --preprocess  --frames ${NUMFRAMES}
