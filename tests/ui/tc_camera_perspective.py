...
def test_cam_perspective_main(params, record_xml_attribute):
    ...
    try:
        ...
        verified_perspective_change = (
            cam_values_change_temp[0] != cam_values_init[0]
        ) and (map_values_change_temp[0] != map_values_init[0])
        ...
        postreset_saved_perspective = (
            cam_values_reset_temp == cam_values_reset_saved
        ) and (map_values_reset_temp == map_values_reset_saved)
        ...
        if (
            logged_in
            and changed_perspective
            and verified_perspective_change
            and perspective_reset
            and postreset_saved_perspective
            and saved_perspective_match_init
        ):
            exit_code = 0
