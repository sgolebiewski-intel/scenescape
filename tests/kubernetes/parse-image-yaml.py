...
def checkImages(images, validImages):
    ...
    result = ' '.join(
        [f"{validImages[image]}:{imageOption[image]}={count}" for image, count in imageCount.items()])
...
if __name__ == "__main__":
    ...
    # Make sure that the service names in our docker compose match the
