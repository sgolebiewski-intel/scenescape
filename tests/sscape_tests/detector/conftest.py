...
def tesseract_detector():
    ...
    tesseract_obj.setParameters(
        tesseract_model, device, plugin, threshold, openvino_cores
    )
...
def ovms_detector():
    ...
    detector_obj.setParameters(
        ovms_retail_model, device, plugin, threshold, openvino_cores
    )
...
def ovms_hpe():
    ...
    detector_obj.setParameters(
        ovms_hpe_model, device, plugin, threshold, openvino_cores
    )
