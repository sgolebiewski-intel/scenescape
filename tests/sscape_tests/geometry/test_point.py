...
@pytest.mark.parametrize(
    ...
    [
        ...
        ([4.0, 6.0, None], None, (4, 6, None)),
        ([4.0, 6.0, None], True, (4, 6, None)),
        ([5.0, 7.0, 11.0], None, (5, 7, 11)),
        ([5.0, 7.0, 11.0], True, (5, 7, 11)),
        ([13.0, 17.0, 29.0], True, (13, 17, 29)),
    ],
)
...
@pytest.mark.parametrize(
    "fixture, tuple, expected_result",
    [
        ("point2d", (2.0, 2.0), (5.0, 7.0, None)),
        ("point3d", (2.0, 2.0, 2.0), (5.0, 7.0, 9.0)),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [("point2d", "Cannot get Z from 2D point"), ("point3d", 8)],
)
...
@pytest.mark.parametrize(
    "fixture, expected_result",
    [("point2d", 7.211102550927978), ("point3d", 10.770329614269007)],
)
...
def test_asCartesian(fixture, expected_result, request):
    ...
    assert np.allclose(
        np.array(cartesian_array, dtype=float),
...
def test_asPolar(fixture, expected_result, request):
    ...
    assert np.allclose(
        np.array(polar_array, dtype=float),
        np.array(expected_result, dtype=float),
        rtol=1e-03,
        equal_nan=True,
    )
...
@pytest.mark.parametrize(
    "fixture", [("point2d"), ("point2d_polar"), ("point3d"), ("point3d_polar")]
)
...
@pytest.mark.parametrize(
    "fixture, tuple, expected_result",
    [
        ("point2d", (-1.0, -1.0), (-1.0, -1.0, None)),
        ("point2d_polar", (-1.0, -1.0), "Cannot do Cartesian math on polar points"),
    ],
)
...
@pytest.mark.parametrize(
    "fixture, tuple, expected_result",
    [("point2d", (1.0, 1.0), False), ("point2d", (0.0, 0.0), True)],
)
