...
@pytest.mark.parametrize(
    "uuid, name, info, point, expected_result",
    [
        (
            "39bd9698-8603-43fb-9cb9-06d9a14e6a24",
            "test_region",
            [[2, 1], [5, 1], [5, 4], [2, 4]],
            geometry.Point(1, 2),
            False,
    ...
    [
        ...
        (
            geometry.Region(
                "39bd9698-8603-43fb-9cb9-06d9a14e6a24",
                "region_poly",
                [(2.3, 1.5), (5.1, 1.0), (5.2, 4.1), (2.7, 4.9)],
            ),
            [(2, 1), (5, 1), (5, 4), (2, 4)],
        ),
    ],
...
@pytest.mark.parametrize(
    ...
    [("region_poly", [[2, 1], [5, 1], [5, 4], [2, 4]]), ("region_circle", None)],
)
