...
def point2d_polar():
    ...
    return geometry.Point(4.0, 6.0, polar=True)
...
def point3d():
    ...
    return geometry.Point(4.0, 6.0, 8.0)
...
def point3d_polar():
    ...
    return geometry.Point(4.0, 6.0, 8.0, polar=True)
...
def line2d():
    ...
    start_point = geometry.Point(1.0, 3.0)
    end_point = geometry.Point(2.0, 3.0)
...
def line3d():
    ...
    start_point = geometry.Point(1.0, 3.0, 5.0)
    end_point = geometry.Point(2.0, 3.0, 5.0)
