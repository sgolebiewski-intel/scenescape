...
def result_data():
    ...
    return {
        "0": [2.438122272491455, 3.192995548248291, 2.384185791015625e-07],
...
def pose():
    ...
    return [
        [9.99999812e-01, -3.30341658e-04, -5.16601898e-04, 2.00181944e00],
        [-1.34154251e-04, -9.39934076e-01, 3.41355995e-01, 3.02465995e-01],
        [-5.98335833e-04, -3.41355862e-01, -9.39933943e-01, 3.00006334e00],
...
def apriltags2d():
    ...
    return {
        "1": [295.3290322, 374.59052971],
        "2": [490.21324187, 119.2943957],
        "3": [570.92463555, 268.3864069],
        "4": [174.86040057, 109.76156221],
    }
