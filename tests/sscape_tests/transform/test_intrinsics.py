...
@pytest.mark.parametrize(
    "camIntrinsics, distortion, resolution",
    [(80, None, [1280, 720]), ([80], None, [1280, 720]), ([45, 30], None, [1280, 720])],
)
...
@pytest.mark.parametrize(
    "camIntrinsics, distortion, resolution",
    [(None, None, None), (None, None, [1280, 720]), ([], None, None)],
)
