...
def build_argparser():
    ...
    parser.add_argument(
        "--brokerauth",
        default="/run/secrets/controller.auth",
    ...
    parser.add_argument(
        "--ntp",
        help="NTP server, default is to use mqtt broker")
    script_path = os.path.abspath(__file__)
    parser.add_argument(
        "--tracker_config_file",
        help="JSON file with tracker configuration for time-based parameters",
    ...
    parser.add_argument(
        "--visibility_topic",
        help="Which topic to publish visibility on."
