    ...
    def scenescapeSceneUpdateSensors(self, mScene, force=False):
        ...
        for sensor in self.sensor_set.all():
            if sensor.type == "camera" and (
                ...
                if (
                    cam.intrinsics_fx != None
                    and cam.intrinsics_fy != None
                    and cam.intrinsics_cx != None
                    and cam.intrinsics_cy != None
                ):
                    sInfo["intrinsics"] = [
                        cam.intrinsics_fx,
                        cam.intrinsics_fy,
                ...
                if (
                    cam.distortion_k1 != None
                    and cam.distortion_k2 != None
                    and cam.distortion_p1 != None
                    and cam.distortion_p2 != None
