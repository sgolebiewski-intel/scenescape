...
urlpatterns += [path('api/',
                ...
                path('api/v1/auth',
                     ...
                     name='api_token_auth'),
                path('api/v1/database-ready',
                     views.DatabaseReady.as_view()),
                path('api/v1/calculateintrinsics',
                     CalculateCameraIntrinsics.as_view()),
                path('api/v1/aclcheck',
                     views.ACLCheck.as_view())]

if settings.KUBERNETES_SERVICE_HOST:
    urlpatterns += [path('api/v1/model-directory/',
                         ModelDirectory.as_view(), name='model-directory'), ]
