...
def pose_from_cluster(
    dataset_dir, q, retrieved, feature_file, match_file, skip=None, match_dense=False
):
...
def main(
    ...
    for q in tqdm(queries):
        ...
        ret, mkpq, mkpr, mkp3d, indices, num_matches = pose_from_cluster(
            dataset_dir, q, db, feature_file, match_file, skip_matches, match_dense
        )
    ...
    if poses_gt_file is not None:
        ...
        thresholds_tRdeg = ((0.01, 1.0), (0.02, 2.0), (0.05, 5.0), (0.1, 10.0))
